...
class TestEvertAcoustics(unittest.TestCase):
    def testRenderHouseWithAcousticsPath(self):
        ...
        agentNp.setPos(LVecBase3f(-0.993, 1.426, 1.230))
        ...
        objectNp.setPos(LVecBase3f(0.119, 2.880, 1.230))
        objectNp.setHpr(LVecBase3f(0, 0, 0))
        ...
        acoustics = EvertAcoustics_jz(
            scene, None, samplingRate, maximumOrder=-1, microphoneTransform=microtransform, ray_tracing=True,
        maxBufferLength=12)
        acoustics.world.add_source([2.5, 3.73, 1.76])
        acoustics.world.compute_rir()
        print(acoustics.world.rir)
        # acoustics.world.simulate()
        # acoustics.world.add_microphone([3,2,1])
        # acoustics.world.add_microphone([0,1,2])

        # acoustics.world.image_source_model()

        # acoustics.world.ray_tracing()
        # acoustics.world.compute_rir()
        # print(acoustics.world.measure_rt60())
       # Create a plot
