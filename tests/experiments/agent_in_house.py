...
####
house = SunCgSceneLoader.loadHouseFromJson("0004d52d1aeeb8ae6de39d6bd993e992", TEST_SUNCG_DATA_DIR)
####
render = Panda3dRenderer(house, shadowing=False,cameraTransform=None, mode='offscreen')

#house = SunCgSceneLoader.loadFromJson(
...
render.step(100)
image = render.getRgbImages()
depth = render.getDepthImages()
